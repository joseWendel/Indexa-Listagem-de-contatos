...
// implements - indica q queremos usar o metodo onInit do ciclo de vida
export class ListaContatosComponent implements OnInit {
  ...
  // private - modificador de acesso, variavel declarada automaticamente como propriedade da classe
  constructor(private contatoService: ContatoService) {}

  // ngOnInit - inicializa a logica assim q o componente é iniciado. É um ciclo de vida
  ngOnInit() {
